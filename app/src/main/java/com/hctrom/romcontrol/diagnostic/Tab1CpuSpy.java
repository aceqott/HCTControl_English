...
public class Tab1CpuSpy extends Fragment {
    ...
    private View generateStateRow(CpuStateMonitor.CpuState state, ViewGroup parent) {
        ...
        }else if (PreferenceManager.getDefaultSharedPreferences(_app.getApplicationContext()).getInt("theme_prefs", 0) == 4){
            bar.setProgressTintList(ColorStateList.valueOf(_app.getApplicationContext().getResources().getColor(R.color.myPrimaryColorMaterialDark)));
